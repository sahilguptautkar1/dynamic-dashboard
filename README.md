...
## Deployed Link: 
Click Here -> [Dynamic-Dashboard-App](https://dynamic-dashboard-assignment.netlify.app/)
...
- ### Search Functionality:
    - A search bar allows users to quickly find widgets based on their names.
    - The search input automatically clears when the "Filter Widgets" button is clicked to ensure the most relevant widgets are displayed.
- ### Responsive UI:
